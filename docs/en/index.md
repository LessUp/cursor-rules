...
import {
  ...
  thesisCards,
  thesisSection,
} from '../.vitepress/theme/content/site-content-en'
    ...
    <div class="feature-map curriculum-grid">
      <article v-for="track in curriculumTracks" :key="track.title" class="feature-card curriculum-card">
        ...
        <div class="feature-tags">
          <a :href="toPortalHref(track.href)" class="feature-tag">Open section</a>
  ...
  <section id="home-architecture-lab" class="panel">
    ...
    <div class="feature-map architecture-grid">
      ...
      <article class="feature-card diagram-frame">
        ...
        <div class="feature-card-title">Root `.mdc` rules → validation → localized rule pages → Pages</div>
        <p class="feature-card-desc">
          The site is a projection of the source rules, not a hand-maintained duplicate. Validation, catalog generation, and Pages stay aligned through the build pipeline.
        </p>
        <div class="diagram-steps">
          <span class="feature-tag">root *.mdc</span>
          <span class="feature-tag">validation</span>
          <span class="feature-tag">rules.json</span>
          <span class="feature-tag">zh/en rule pages</span>
  ...
  <section id="home-research" class="panel">
    ...
    <div class="feature-map">
      <article v-for="item in researchHighlights" :key="item.title" class="feature-card citation-card">
        ...
        <div class="feature-tags">
          <a :href="toPortalHref(item.href)" class="feature-tag">Read more</a>
        </div>
      </article>
    </div>
  </section>
